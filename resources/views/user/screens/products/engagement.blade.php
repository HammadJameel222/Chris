...
@section('content')
    <script type="text/javascript">
        document.title = "Engagement"
    </script>
    <main>
        <section class="inner-banner engagement ">
            <div class="container">
                <div class="row justify-content-center text-center">
                    <div class="col-lg-12 col-12">
                        <div class="banner-overlay"></div>
                        <h1 class="inner-banner-text">Engagement & Wedding</h1>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row justify-content-center text-center">
                    <div class="col-1g 12 col-12">
                        <h2 class="inner-title mb-90">Our Premium Jewelry</h2>
                    </div>
                </div>
                        ...
                        <div class="row ">
                            <div class="col-lg-4 col-md-6 col-6 mb-30">
                                <div class="bg-box-wrap text-center height-100">
                                    ...
                                    <img src="./assets/images/engagement-prod-img-1.png" class="prods-imgs img-fluid"
                                        alt="">
                                    <div class="inner-box-pad">
                                        <h4 class="text-16 text-w mb-2">Aire Capitol Hill Watch Swiss Made 18 Karat Solid
                                            Gold Power Reserve Luxury Rare Watch - Red Gold®</h4>
                            ...
                            <div class="col-lg-4 col-md-6 col-6 mb-30">
                                <div class="bg-box-wrap text-center height-100">
                                    <div class="content-overlay"></div>
                                    <img src="./assets/images/engagement-prod-img-2.png" class="prods-imgs img-fluid"
                                        alt="">
                                    <div class="inner-box-pad">
                                        <h4 class="text-16 text-w mb-2">Aire Capitol Hill Watch Swiss Made 18 Karat Solid
                                            Gold Power Reserve Luxury Rare Watch - Red Gold®</h4>
                            ...
                            <div class="col-lg-4 col-md-6 col-6 mb-30">
                                <div class="bg-box-wrap text-center height-100">
                                    <div class="content-overlay"></div>
                                    <img src="./assets/images/engagement-prod-img-3.png" class="prods-imgs img-fluid"
                                        alt="">
                                    <div class="inner-box-pad">
                                        <h4 class="text-16 text-w mb-2">Aire Capitol Hill Watch Swiss Made 18 Karat Solid
                                            Gold Power Reserve Luxury Rare Watch</h4>
                                        <div class="d-flex justify-content-center ratings mb-13">
                                            <i class="fa-solid fa-star"></i>
                                            <i class="fa-solid fa-star"></i>
                                            <i class="fa-solid fa-star"></i>
                            ...
                            <div class="col-lg-4 col-md-6 col-6 mm-b-30 mr-b-30">
                                <div class="bg-box-wrap text-center height-100">
                                    <div class="content-overlay"></div>
                                    <img src="./assets/images/engagement-prod-img-7.png" class="prods-imgs img-fluid"
                                        alt="">
                                    <div class="inner-box-pad">
                                        <h4 class="text-16 text-w mb-2">Aire Capitol Hill Watch Swiss Made 18 Karat Solid
                                            Gold Power Reserve Luxury Rare Watch - Red Gold®</h4>
