...
@section('content')
    <script type="text/javascript">
        document.title = "Signature collection"
    </script>
    <main>
        <section class="inner-banner signature-collection">
            <div class="container">
                <div class="row justify-content-center text-center">
                    <div class="col-lg-12 col-12">
                        <div class="banner-overlay"></div>
                        <h1 class="inner-banner-text">Signature Collection</h1>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row justify-content-center text-center">
                    <div class="col-1g 12 col-12">
                        <h2 class="inner-title mb-90">Signature RED GOLD® Collection</h2>
                    </div>
                </div>
