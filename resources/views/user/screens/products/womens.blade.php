...
@section('content')
    ...
    <main>
        <section class="inner-banner womens">
            <div class="container">
                <div class="row justify-content-center text-center">
                    <div class="col-lg-12 col-12">
                        <div class="banner-overlay"></div>
                        <h1 class="inner-banner-text">Women's</h1>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row justify-content-center text-center">
                    <div class="col-1g 12 col-12">
                        <h2 class="inner-title mb-90">Our Jewelry Sets</h2>
                    </div>
                </div>
                        ...
                        <div class="row ">
                            ...
                            {{-- <div class="col-lg-4 col-md-6 col-6 mb-30">
                                <div class="bg-box-wrap text-center height-100">
                                    ...
                                    <img src="{{ asset('assets/images/womens-prod-img-1.png')}}" class="prods-imgs img-fluid"
                                        alt="">
                                    <div class="inner-box-pad">
                                        <h4 class="text-16 text-w mb-2">Hollywood Royalty Set-Gemstones Medley and Diamonds
                                            Set</h4>
                                        ...
                                        <h6 class="cate-text text-w">$ 48,500.00</h6>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-6 mb-30">
                                <div class="bg-box-wrap text-center height-100">
                                    <div class="content-overlay"></div>
                                    <img src="./assets/images/bestseller-img-4.png" class="prods-imgs img-fluid"
                                        alt="">
                                    <div class="inner-box-pad">
                                        <h4 class="text-16 text-w mb-2">Anointed Beauty - 18 Karat White Gold Necklace With
                                            Diamonds And Onyx Set</h4>
                                        <div class="d-flex justify-content-center ratings mb-13">
                                            <i class="fa-solid fa-star"></i>
                                            <i class="fa-solid fa-star"></i>
                                            <i class="fa-solid fa-star"></i>
                            ...
                            <div class="col-lg-4 col-md-6 col-6 mb-30">
                                <div class="bg-box-wrap text-center height-100">
                                    <div class="content-overlay"></div>
                                    <img src="./assets/images/womens-prod-img-2.png" class="prods-imgs img-fluid"
                                        alt="">
                                    <div class="inner-box-pad">
                                        <h4 class="text-16 text-w mb-2">Sunrays - Yellow Aquamarine Necklace and Earring
                                            Set</h4>
                                        <div class="d-flex justify-content-center ratings mb-13">
                                            <i class="fa-solid fa-star"></i>
                                            <i class="fa-solid fa-star"></i>
                            ...
                            <div class="col-lg-4 col-md-6 col-6 mb-30">
                                <div class="bg-box-wrap text-center height-100">
                                    <div class="content-overlay"></div>
                                    <img src="./assets/images/womens-prod-img-3.png" class="prods-imgs img-fluid"
                                        alt="">
                                    <div class="inner-box-pad">
                                        <h4 class="text-16 text-w mb-2">Chris Aire Diamond Earings</h4>
                                        <div class="d-flex justify-content-center ratings mb-13">
                                            <i class="fa-solid fa-star"></i>
                                            <i class="fa-solid fa-star"></i>
                                            <i class="fa-solid fa-star"></i>
                                        ...
                                        <h6 class="cate-text text-w">$ 6,200.00</h6>
                                    </div>
                                    <div class="overlay-btns-wrap inner-pages-btn-wrap">
                                        <div class="mb-50">
                                            <a href="" class="inner-btn ">VIEW DETAILS</a>
                            ...
                            <div class="col-lg-4 col-md-6 col-6 mb-30">
                                <div class="bg-box-wrap text-center height-100">
                                    <div class="content-overlay"></div>
                                    <img src="./assets/images/womens-prod-img-4.png" class="prods-imgs img-fluid"
                                        alt="">
                                    <div class="inner-box-pad">
                                        <h4 class="text-16 text-w mb-2">Chris Aire Gem Symphony Earrings</h4>
                                        <div class="d-flex justify-content-center ratings mb-13">
                                            <i class="fa-solid fa-star"></i>
                                            <i class="fa-solid fa-star"></i>
                                            <i class="fa-solid fa-star"></i>
                                        ...
                                        <h6 class="cate-text text-w">$ 18,500.00</h6>
                                    </div>
                                    <div class="overlay-btns-wrap inner-pages-btn-wrap">
                                        <div class="mb-50">
                                            <a href="" class="inner-btn ">VIEW DETAILS</a>
                            ...
                            <div class="col-lg-4 col-md-6 col-6 mb-30">
                                <div class="bg-box-wrap text-center height-100">
                                    <div class="content-overlay"></div>
                                    <img src="./assets/images/womens-prod-img-5.png" class="prods-imgs img-fluid"
                                        alt="">
                                    <div class="inner-box-pad">
                                        <h4 class="text-16 text-w mb-2">Chris Aire Diamond Earings</h4>
                                        <div class="d-flex justify-content-center ratings mb-13">
                            ...
                            <div class="col-lg-4 col-md-6 col-6 mb-30">
                                <div class="bg-box-wrap text-center height-100">
                                    <div class="content-overlay"></div>
                                    <img src="./assets/images/womens-prod-img-1.png" class="prods-imgs img-fluid"
                                        alt="">
                                    <div class="inner-box-pad">
                                        <h4 class="text-16 text-w mb-2">Hollywood Royalty Set-Gemstones Medley and Diamonds
                                            Set</h4>
